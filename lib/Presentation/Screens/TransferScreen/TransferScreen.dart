...
class _TransferScreenState extends State<TransferScreen> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() {
      context.read<TransferBloc>().add(FetchTransferEvent(page: _currentPage));
    });
  }
    ...
    setState(() {
      ...
      if (!_isSearching) {
        context.read<TransferBloc>().add(
          FetchTransferEvent(page: _currentPage),
        );
      }
    });
  }
              ...
              child: BlocBuilder<TransferBloc, TransferState>(
                builder: (context, state) {
                  ...
                  if (state is TransferLoaded) {
                    ...
                    final totalPages = state.transfers.TotalPages;
